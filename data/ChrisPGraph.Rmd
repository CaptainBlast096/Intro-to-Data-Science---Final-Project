...
```{r}
steam_data <- read.csv(url("https://raw.githubusercontent.com/CaptainBlast096/Intro-to-Data-Science---Final-Project/main/data/steam.csv?token=AUYBUGFTVT4MWJCRESJF6LDBB4YYG"))
